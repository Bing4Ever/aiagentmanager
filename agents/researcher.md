...
- Analyze target users, jobs to be done, pain points, market signals, trends, and willingness to pay.
...
- Identify assumptions that require interviews, prototypes, experiments, or additional data.
